...
<html lang="en">
<head>
    <title>Portfolio - Jake Buhite</title>
...
<body>
    ...
    <div class="container">
        <div class="content" id="large_title"><strong>Portfolio</strong></div>
        <div class="content" id="text">Here are a few projects I have worked on.</div>
        <div class="portfolio-grid">
            <div class="portfolio-item"><img src="https://fakeimg.pl/400x250/a9a9a9/" alt="project1" /></div>
            <div class="portfolio-item"><img src="https://fakeimg.pl/400x250/a9a9a9/" alt="project2" /></div>
            <div class="portfolio-item"><img src="https://fakeimg.pl/400x250/a9a9a9/" alt="project3" /></div>
